...
<div
    ...
    class="sidebar fixed inset-y-0 left-0 xl:mt-20 xl:m-2 lg:mt-20 lg:m-2 sm:mt-20 sm:m-2 dark:bg-gray-800 text-gray-800 dark:text-white transform transition-all duration-300 ease-in-out z-50"
    id="sidebar"
>
    <div class="flex flex-col h-full">
        ...
        <!-- Sección superior -->
        <div class="p-4 bg-gray-100 rounded-xl m-2 border-b flex items-center cursor-pointer" id="user_data" title="Ver y editar perfil de usuario">
        ...
        <nav class="flex-grow py-4 rounded-lg border-slate-200">
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 m-2 bg-gray-100 rounded-xl hover:bg-custom-blue dark:hover:bg-gray-700">
                        <i class="fas fa-home mr-3"></i>
                        <span x-show="!collapsed">Inicio</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('projects.index') }}" class="flex items-center px-4 py-3 m-2 bg-gray-100 rounded-xl hover:bg-custom-blue dark:hover:bg-gray-700">
                        <i class="fa-solid fa-briefcase mr-3"></i>
                        <span x-show="!collapsed">Proyectos</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center px-4 py-3 m-2 bg-gray-100 rounded-xl hover:bg-custom-blue dark:hover:bg-gray-700">
                ...
                <li>
                    <a href="{{ route('assets.index') }}" class="flex items-center px-4 py-3 m-2 bg-gray-100 rounded-xl hover:bg-custom-blue dark:hover:bg-gray-700">
