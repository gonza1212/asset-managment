    ...
    <!-- Barra de Herramientas -->
        <div class="flex items-center justify-between mb-4">
            <div class="flex space-x-4">
                ...
                <button class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-red-500 dark:bg-gray-700 dark:hover:bg-gray-700">Finalizar</button>
            </div>
