    ...
    <table class="w-full bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-700">
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="py-3 px-2 border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white hover:text-blue-400"><a href="{{ route('assets.show', $a['id']) }}">{{ $a['description'] }}</a></td>
