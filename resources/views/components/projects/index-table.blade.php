    ...
    <table class="w-full bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-700">
        <thead>
            <tr class="bg-gray-100 border-b dark:bg-gray-700 dark:border-gray-600">
                ...
                <th class="py-3 px-2 text-left border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">Nombre del Proyecto</th>
                ...
                <th class="py-3 px-2 text-left border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">Fecha de Inicio</th>
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="py-3 px-2 border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">{{ $p['finished_at'] }}</td>
                <td class="py-3 px-2 border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">{{ $p['project_manager'] }}</td>
                <td class="py-3 px-2 border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">{{ $p['assets'] }}</td>
                <td class="py-3 px-2 border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">{{ $p['location'] }}</td>
                <td class="py-3 px-2 border-r dark:bg-gray-800 dark:border-gray-700 dark:text-white">{{ $p['priority'] }}</td>
            </tr>
            @endforeach
